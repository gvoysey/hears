...
from hears.filtering.filterbank import FunctionFilterbank, CombinedFilterbank
...
class DRNL(CombinedFilterbank):
    ...
    def __init__(self, source, cf, type='human', param={}):
        ...
        bandpass_nonlinear1 = ApproximateGammatone(source, cf_nonlinear, bandwidth_nonlinear,
        ...
        # bandpass filter (third order gammatone filters)
        bandpass_nonlinear2 = ApproximateGammatone(compression, cf_nonlinear, bandwidth_nonlinear,
                                                   order=parameters['order_nonlinear'])
        # low pass filter
