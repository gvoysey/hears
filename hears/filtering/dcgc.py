...
from hears.filtering.filterbank import ControlFilterbank, CombinedFilterbank, RestructureFilterbank
...
class AsymCompUpdate:
    ...
    def __call__(self, *input):
        ...
        fr2 = self.fp1 * frat
        self.iteration += 1
        self.target.filt_b, self.target.filt_a = asymmetric_compensation_coeffs(self.samplerate, fr2,
                                                                                self.target.filt_b, self.target.filt_a,
                                                                                self.b, self.c, self.p0, self.p1,
...
class DCGC(CombinedFilterbank):
    ...
    def __init__(self, source, cf, update_interval=1, param={}):
        ...
        control = ControlFilterbank(signal_path, [pGc_control, asym_comp_control], signal_path, updater,
                                    update_interval)
